...
public class UIBubble : UIBase
{
    ...
    {
        var instance =   InterfaceRoot.instance.UIPool<UIBubble>(Utility.Store.instance.page.prefab_bubblePage, page);
    ...
    static Texture imgDefault 
    {
        get {
            if (mImgDefault == null)
                mImgDefault = Utility.Store.instance.page.prefab_bubblePage.GetComponent<UIBubble>().imgIcon.mainTexture;
            return mImgDefault;
        }
    }
