...
namespace Center
{
    public class UIAdmin : UIBase
    {
        ...
        void list()
        {
            ...
            cmds.Add(new cmd()
            {
                ...
                exe = (val) =>
                {
                    ...
                    foreach (var item in Center.LoadCenter.instance.ApiHistoryDatas.OrderByDescending(x => x.date))
                    {
                        let.Add(new cmd()
                        {
                            key = item.url,
        ...
        public static UIAdmin Open()
        {
            ...
            if (!instance)
            {
                instance = CreatePage<UIAdmin>(Center.Store.instance.page.prefab_admin);
                instance.Init();
            }
            return instance;
        }
